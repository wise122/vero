        ...
        <div class="row">
            <div class="col-md-8">
              <div class="rounded-xl p-4 mb-3" v-for="artikel in listArtikels" :key="artikel.id_artikel">
                <nuxt-link :to="`/home/artikel/${artikel.id_artikel}`" style="text-decoration: unset;">
                  <ArtikelThumbnail
                    :data="artikel" 
                  />
                </nuxt-link>
            ...
            <div class="col-md-4">
              <div class="rounded-xl p-4 mb-3">
                ...
                <nuxt-link v-for="(artikel) in listArtikels" :key="artikel.id_artikel" :to="`/home/artikel/${artikel.id_artikel}`" style="text-decoration: unset;">
                  <ArtikelThumbnail
                    :data="artikel" 
                  />
                </nuxt-link>
